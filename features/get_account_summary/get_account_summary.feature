Feature: Get the 401k information
  Scenario: Get the 401k information
    ...
    And the Paychex object contains a current_balance member variable set to "$XX,XXX.XX" while mocking
    And the Paychex object contains a vested_balance member variable set to "$XX,XXX.XX" while mocking
    And the Paychex object contains a personal_ror member variable set to "X.X%" while mocking
